...
#include "MyProject2OffroadCar.h"
#include "MyProject2OffroadWheelFront.h"
#include "MyProject2OffroadWheelRear.h"
...
AMyProject2OffroadCar::AMyProject2OffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UMyProject2OffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UMyProject2OffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UMyProject2OffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UMyProject2OffroadWheelRear::StaticClass();
