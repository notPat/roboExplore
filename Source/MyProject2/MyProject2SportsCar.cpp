...
#include "MyProject2SportsCar.h"
#include "MyProject2SportsWheelFront.h"
#include "MyProject2SportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AMyProject2SportsCar::AMyProject2SportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UMyProject2SportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UMyProject2SportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UMyProject2SportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UMyProject2SportsWheelRear::StaticClass();
